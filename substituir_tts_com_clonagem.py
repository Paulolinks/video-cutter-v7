...
# -*- coding: utf-8 -*-
"""
Script para substituir a função gerar_audio_tts pela versão com clonagem de voz
"""

import re

def substituir_funcao_gerar_audio_tts_com_clonagem():
    """Substitui a função gerar_audio_tts pela versão com clonagem de voz"""
    
    print("🔧 Substituindo função gerar_audio_tts pela versão com clonagem de voz...")
    
    # Ler a função corrigida
    with open('funcao_gerar_audio_tts_com_clonagem.py', 'r', encoding='utf-8') as f:
    ...
    with open('app_backup6.py', 'w', encoding='utf-8') as f:
        f.write(content)
    print("✅ Backup criado: app_backup6.py")
    ...
    print("✅ Função gerar_audio_tts substituída pela versão com clonagem de voz!")
    print("📁 Backup salvo em: app_backup6.py")
    print("🔄 Arquivo app.py atualizado")
    
    return True

if __name__ == "__main__":
    substituir_funcao_gerar_audio_tts_com_clonagem()
